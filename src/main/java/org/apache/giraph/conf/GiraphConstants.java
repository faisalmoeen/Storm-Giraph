...
public interface GiraphConstants {
    ...
    /**
     * Minimum number of simultaneous sources before this job can run (int)
     */
    String MIN_SOURCES = "giraph.minSources";
    /**
     * Maximum number of simultaneous source tasks started by this job (int).
     */
    String MAX_SOURCES = "giraph.maxSources";
    ...
    /**
     * Minimum percent of the maximum number of sources that have responded
     * in order to continue progressing. (float)
     */
    FloatConfOption MIN_PERCENT_SOURCES_RESPONDED =
            new FloatConfOption("giraph.minPercentSourcesResponded", 100.0f,
                    "Minimum percent of the maximum number of sources that have " +
                            "responded in order to continue progressing. (float)");
