 ...
 */
public class MutationSplitEvents {
    /** Input splits are ready for consumption by workers, written by Master */
    private final BspEvent startMutationChanged;
    /** Input split reservation or finished notification and synchronization */
    private final BspEvent stateChanged;
    /** Input splits are done being processed by workers, written by Master */
    private final BspEvent allDoneChanged;
    /** Input split done by a worker finished notification and synchronization, written by Worker */
     ...
     */
    public MutationSplitEvents(Progressable progressable) {
        startMutationChanged = new PredicateLock(progressable);
     ...
     */
    public BspEvent getStartMutationChanged() {
        return startMutationChanged;
    }
