...
public abstract class BspService<I extends WritableComparable,
    ...
    /** Healthy sources register here. */
    public static final String SOURCE_HEALTHY_DIR = "/_sourceHealthyDir";
    /** Unhealthy sources register here. */
    public static final String SOURCE_UNHEALTHY_DIR = "/_sourceUnhealthyDir";
    ...
    /** Finished sources notify here */
    public static final String SOURCE_FINISHED_DIR = "/_sourceFinishedDir";
    ...
    /** Has source registration changed (either healthy or unhealthy) */
    ...
    public BspService(
        ...
        registerBspEvent(sourceHealthRegistrationChanged);
    ...
    /**
     * Generate the source information "healthy" directory path for a
     * superstep
     *
     * @param attempt application attempt number
     * @param superstep superstep to use
     * @return directory path based on the a superstep
     */
    public final String getSourceInfoHealthyPath(long attempt,
                                                 long superstep) {
        return applicationAttemptsPath + "/" + attempt +
                SUPERSTEP_DIR + "/" + superstep + SOURCE_HEALTHY_DIR;
    }
    ...
    /**
     * Generate the source information "unhealthy" directory path for a
     * superstep
     *
     * @param attempt application attempt number
     * @param superstep superstep to use
     * @return directory path based on the a superstep
     */
    public final String getSourceInfoUnhealthyPath(long attempt,
                                                   long superstep) {
        return applicationAttemptsPath + "/" + attempt +
                SUPERSTEP_DIR + "/" + superstep + SOURCE_UNHEALTHY_DIR;
    }
    ...
    /**
     * Generate the source "finished" directory path for a
     * superstep
     *
     * @param attempt application attempt number
     * @param superstep superstep to use
     * @return directory path based on the a superstep
     */
    public final String getSourceFinishedPath(long attempt, long superstep) {
        return applicationAttemptsPath + "/" + attempt +
                SUPERSTEP_DIR + "/" + superstep + SOURCE_FINISHED_DIR;
    }
    ...
    public final BspEvent getSourceHealthRegistrationChangedEvent() {
        return sourceHealthRegistrationChanged;
    }
